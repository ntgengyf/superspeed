...
preinfo() {
	...
	echo "       节点列表:  https://www.speedtest.net/speedtest-servers-static.php"
	#https://github.com/spiritLHLS/speedtest.net-CN-ID/tree/main
	echo "       节点更新: 2025/04/29  | 脚本更新: 2020/04/09"
	echo "——————————————————————————————————————————————————————————"
}
...
runtest() {
	...
	if [[ ${selection} == 1 ]]; then
		...
		start=$(date +%s) 
		 ...
		 speed_test '59387' '浙江５Ｇ' '电信'
		 speed_test '59386' '浙江５Ｇ' '电信'
		...
		#***
		 ...
		 speed_test '16204' '江苏苏州' '移动'
		 speed_test '54312' '杭州 5G' '移动'
		 speed_test '60584' '深圳 5G' '移动'
		 speed_test '60794' '广州 5G' '移动'
		#***
		 speed_test '30852' '昆山杜克大学'
		 speed_test '69872' '西交利物浦大学'
